...
const translations = {
  ar: {
    ...
    termsOfUseIntroduction: "تحدد هذه الشروط العلاقة بين: (1) مستخدمي المنصة (بما في ذلك العملاء)، (2) مقدمي الخدمات (المحاسبين/المدققين)، و(3) [منصة حسابي]. باستخدام المنصة، توافق على الالتزام بهذه الشروط، وسياسات المنصة (الخصوصية، NDA، سياسة الدفع، سياسة النزاعات).\nهذه الشروط تحكم استخدامكم لـ [منصة حسابي]، وفقاً لقانون حماية المستهلك العماني (هيئة حماية المستهلك) وقانون التجارة الإلكترونية.\nالمنصة غير مسؤولة عن جودة الخدمات؛ هي وسيط فقط.",
    termsOfUseAccountRegistrationTitle: "1. تسجيل الحساب",
    termsOfUseAccountRegistrationContent: "يجب تقديم معلومات صحيحة وكاملة عند التسجيل، وتحديثها عند الضرورة.\nيجب أن تكونوا فوق 18 عاماً، مقيمين في عمان أو دول معترف بها.\nالمستخدم مسؤول عن سرية كلمة المرور؛ نحن غير مسؤولين عن الوصول غير المصرح به.",
    termsOfUsePlatformServicesTitle: "2. خدمات المنصة",
    termsOfUsePlatformServicesContent: "المنصة تعمل كوسيط تقني يربط بين العملاء ومقدمي الخدمات؛ لا تقوم المنصة بنفسها بتقديم خدمات المحاسبة، إنما تُسهّل التعاقد. المنصة ليست طرفاً في العقود المباشرة بين العميل ومقدم الخدمة إلا في حالات محددة ينص عليها صراحةً.",
    termsOfUseResponsibilitiesTitle: "3. مسؤوليات الأطراف",
    termsOfUseResponsibilitiesContent: "مقدّم الخدمة: يتحمل مسؤولية جودة العمل، الامتثال لمعايير المهنة، الحصول على التراخيص اللازمة، والالتزام بسرية بيانات العميل.\nالعميل: تقديم معلومات صحيحة، دفع المبالغ عند استحقاقها، وتقديم تقييم عادل للعمل عند الانتهاء.\nالمنصة: تشغيل البنية التحتية، تحصيل المدفوعات (إن وُجد نظام تحصيل)، توفير آليات حل النزاع والتحقق الأساسي (KYC)، وتطبيق قواعد المجتمع. المنصة لا تضمن نتائج العمل ولن تكون مسؤولة عن الأخطاء المهنية للمحاسب.",
    termsOfUsePaymentsTitle: "4. المدفوعات ورسوم المنصة",
    termsOfUsePaymentsContent: "توضح المنصة آلية الدفع: العميل يودع المبلغ في حساب ضمان (Escrow) إلى أن يؤكد الاستلام/الجودة، ثم تُصرف للمحاسب بعد خصم رسوم المنصة/ضرائب مطبقة.\nرسوم الخدمة ورسوم الانسحاب والضرائب تُعرض بشفافية عند توقيع العقد. أي خصم ضرائب يخضع للقوانين المحلية.\nالدفع آمن عبر [مزودين]؛ نحتفظ بالأموال حتى الاستلام.\nرسوم المنصة: [ 10% من القيمة].\nاسترداد: خلال 7 أيام إذا لم تُقدم الخدمة.",
    termsOfUseCancellationTitle: "5. سياسة الإلغاءات والاسترداد",
    termsOfUseCancellationContent: "تُحدد الشروط بين الأطراف عند قبول العرض: استرداد جزئي/كامل بحسب نسبة العمل المُنجز، وجود إخلال من قِبل مقدّم الخدمة أو العميل. توفر المنصة آلية تسوية نزاع و/أو فصل دفعات escrow وفق دليل النزاعات.",
    termsOfUseReviewsTitle: "6. تقييمات ومراجعات",
    termsOfUseReviewsContent: "يسمح للعميل بتقييم العمل؛ يمنع نشر بيانات كاذبة أو تشهيرية، وسياسة للرد على التقييمات والمراجعات المزعومة.",
    termsOfUseComplianceTitle: "7. الامتثال للضرائب وAML/KYC",
    termsOfUseComplianceContent: "يلتزم مقدمو الخدمة والعملاء بالامتثال لمتطلبات الضرائب العُمانية وأية التزامات إفصاحية. تلتزم المنصة بجمع معلومات KYC الأساسية وتعاون مع الجهات الرقابية عند الشك بعمليات غسيل أموال/تمويل إرهاب. توظيف مزودي خدمات التحقق كجهات طرف ثالث شائعة.",
    termsOfUseIntellectualPropertyTitle: "8. الملكية الفكرية",
    termsOfUseIntellectualPropertyContent: "يظل أي محتوى أصلي ينشئه مقدم الخدمة ملكاً لمنشئه إلا إذا اتفق الطرفان على نقل الحقوق كتابياً. يمنح العميل ترخيصاً لاستخدام النواتج التي دُفِع ثمنها، حسب الاتفاق.",
    termsOfUseLiabilityTitle: "9. حدود المسؤولية",
    termsOfUseLiabilityContent: "النزاعات: تُسعى النزاعات أولاً لحلها داخلياً عبر آلية تسوية النزاع بالمنصة. إن تعذّر الحل، يُحال النزاع إلى محاكم سلطنة عُمان أو إلى تحكيم حسب اتفاق الأطراف، ويُطبق قانون سلطنة عُمان.\nالمحدودية: المنصة غير مسؤولة عن أخطاء الخدمة؛ الحد الأقصى للتعويض هو قيمة الخدمة.\nالإنهاء: نحق إنهاء الحساب لانتهاكات (مثل الاحتيال).",
    termsOfUseIndemnityTitle: "10. التعويض (Indemnity)",
    termsOfUseIndemnityContent: "يلتزم كل مستخدم بتعويض المنصة عن أي مطالبات ناتجة عن خرق للشروط أو سوء استخدامها للخدمة أو خرق حقوق طرف ثالث.",
    termsOfUseAccountTerminationTitle: "11. إنهاء الحساب",
    termsOfUseAccountTerminationContent: "للمنصة الحق في تعليق أو إنهاء الحسابات عند الخرق الجوهري للشروط أو عند الاشتباه بسلوك احتيالي، مع إشعار و/أو إجراءات استرداد للأموال المودعة حسب سياسة الاسترداد.",
    termsOfUseGoverningLawTitle: "12. القانون الحاكم",
    termsOfUseGoverningLawContent: "تُحكم هذه الشروط بقوانين سلطنة عمان. للشكاوى، اتصلوا بدعم العملاء أو هيئة حماية المستهلك.",
    termsOfUseModificationsTitle: "13. التعديلات",
    termsOfUseModificationsContent: "تحتفظ المنصة بالحق في تعديل الشروط مع نشر إشعار بتحديثات جوهرية قبل سريانها، ومطالبة المستخدمين بالموافقة عند الحاجة.",
    termsOfUseContactTitle: "14. الاتصال والبلاغات القانونية",
    termsOfUseContactContent: "جميع الإشعارات يجب أن توجه إلى قنوات الاتصال الرسمية المبينة في صفحة \"اتصل بنا\" وسيكون العنوان القانوني المدرج في السجلات هو المقبول للتنبيهات الرسمية.",
