              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">
                    Manage accounting firms and their information
                  </p>
                </div>
              </div>
            </div>
                ...
                {selectedFirm && (
                  ...
                  >
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Review the information and approve or reject this
                        account.
                      </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1 sm:col-span-2">
                        ...
                        <div className="text-sm text-neutral-700 dark:text-neutral-300">
                          Additional details or notes can go here.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-2 pt-2">
                      ...
                      <Button
                        variant="destructive"
                        onClick={() =>
                          updateStatus(selectedFirm.id, "Inactive")
                        }
                      >
                        Reject
                      </Button>
