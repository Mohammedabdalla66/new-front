...
import { toggleTheme, setLanguage, selectTheme, selectLanguage } from '../../features/theme/themeSlice';
                  ...
                  {({ active }) => (
                    <button
                      ...
                      className={`${
                        ...
                        language === 'en' ? 'text-primary-600 font-medium' : 'text-neutral-700 dark:text-neutral-300'
                  ...
                  {({ active }) => (
                    <button
                      ...
                      className={`${
                        ...
                        language === 'ar' ? 'text-primary-600 font-medium' : 'text-neutral-700 dark:text-neutral-300'
