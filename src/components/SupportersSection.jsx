      ...
      <div className="bg-white py-8 border-t">
        <div className="max-w-2xl mx-auto px-10 sm:px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-12">
            ...
            <img src="../assets/download1.png" alt="Partner Logo" className="h-10 sm:h-12 object-contain opacity-70 hover:opacity-100 transition-opacity" onError={(e) => { e.target.style.display = 'none'; }} />
            <img src="../assets/oman_data_park_logo (1).jpg" width={100} height={100} alt="Partner Logo" className="h-10 sm:h-12 object-contain opacity-70 hover:opacity-100 transition-opacity" onError={(e) => { e.target.style.display = 'none'; }} />
          </div>
        </div>
      </div>
    </section>
